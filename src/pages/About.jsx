  ...
  return (
    <div>
      <PageHero
        ...
        badge="Bongbine Ltd"
        bgImage="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&crop=edges&w=1920&q=80"
      />
        ...
        <div className="container">
          ...
          <div className="editorial-list">
            {CORE_VALUES.map((val, idx) => (
              <div key={val.id} className="editorial-list-item" style={{ gridTemplateColumns: '100px 300px 1fr', alignItems: 'start' }}>
