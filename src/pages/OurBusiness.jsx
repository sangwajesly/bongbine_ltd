  ...
  return (
    <div>
      <PageHero
        ...
        badge="Bongbine Ltd"
        bgImage="/images/pexels-the-artboard-131151099-18346466.jpg"
      />
          ...
          <div className="grid-asymmetric">
            ...
            <div className="editorial-list">
              {businessHighlights.map((hl, idx) => (
                <RevealText key={hl.title} delay={0.1 * idx} className="editorial-list-item" style={{ gridTemplateColumns: '40px 1fr', gap: '1.5rem', padding: '2rem 0' }}>
            ...
            {BUSINESS_DIVISIONS.map((division, idx) => (
              <div key={division.id} className={idx % 2 === 0 ? "grid-asymmetric" : "grid-asymmetric-rev"}>
                ...
                <div style={{ order: idx % 2 === 0 ? 1 : 0, padding: '0 2rem' }}>
                  ...
                  <RevealLine className="structural-line" delay={0.1} style={{ margin: '2rem 0' }} />
